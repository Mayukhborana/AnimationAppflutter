...
class hermione extends StatefulWidget {
  @override
  _hermioneState createState() => _hermioneState();
}

class _hermioneState extends State<hermione> with TickerProviderStateMixin {
  var myanicon;
  var animation;
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: AssetImage('assets/32.gif'),
                                  fit: BoxFit.fill)),
                        ),
                      ],
                    ),
